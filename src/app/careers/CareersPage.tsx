...
// The local 'jobPositions', 'companyValues', and 'perks'
// arrays have been removed as they are now sourced
// from the 'careersBlock' prop.

export default function CareersPage({ careersBlock, cta }: any) {
  console.log("CareersPage careersBlock:", careersBlock);
