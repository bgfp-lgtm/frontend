...
export default function FilmProductionPage() {
  const services = [
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1624961151169-b3df5c0f06ab?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8U3Rvcnlib2FyZGluZ3xlbnwwfHwwfHx8MA%3D%3D",
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?q=80&w=1887&auto=format&fit=crop",
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1467987506553-8f3916508521?q=80&w=1887&auto=format&fit=crop",
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=1887&auto=format&fit=crop",
    },
    {
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=1887&auto=format&fit=crop",
    },
    {
      ...
      imageUrl:
        "https://plus.unsplash.com/premium_photo-1721787470431-8caeeabcdb72?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8VmlzdWFsJTIwU3Rvcnl0ZWxsaW5nfGVufDB8fDB8fHww",
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1887&auto=format&fit=crop",
    },
    {
        ...
        <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto">
              From pre-production to final delivery, we manage and execute every
              stage with precision and creativity.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Complete film production services covering every aspect from
