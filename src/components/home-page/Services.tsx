...
import {
  ...
  BsClipboardData,
  BsMegaphone,
  BsCode, // Added a default icon
} from "react-icons/bs";
import { StrapiImage } from "@/components/StrapiImage"; // Assuming you have this
import { getStrapiMedia } from "@/lib/utils"; // Assuming you have this
